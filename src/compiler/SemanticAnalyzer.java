...
//return for_st();//////////////////////////////////////////
   return     OE(ST.S.pop(),ST.ClassAttribute.get(i).Name,this.T6);/////////////////////////////////////
 //  return DO_While_st();
//   return Declearation();//////////////////////////////
...
//         i++;
//        String OP1= token.get(i).cv;
//         String temp=T5;
//        if(AE(s,cc,T5)){
//        this.T5= ST.Compatibility(OP1, temp, T5);
//        if(this.T5==null){
//            System.out.println("UncompatibleTYPE");
//            return false;
//        }
//            if(OEdesh(s,cc,this.T5,T6)){
//                return true;
//    }  }} else{
...
//    if(token.get(i).cp.equals("ANDOR")){
//        i++;
//               String OP2= token.get(i).cv;
//        String temp=T4;
//        if(ROP(s,cc,T4)){
//      this.T4= ST.Compatibility(OP2, temp, T4);
//if(this.T4==null){
//            System.out.println("UncompatibleTYPE");
//            return false;
//        }
//            if(AEdesh(s,cc,this.T4,T5)){
//                return true;
//    }  }} else{
...
//        i++;
//                       String OP3= token.get(i).cv;
//
//
//        String temp=T3;
//        if(exp(s,cc,T3)){
//             this.T3= ST.Compatibility(OP3, temp, T3);
//               if(this.T3==null){
//            System.out.println("UncompatibleTYPE");
//            return false;
//        } 
//            if(ROPdesh(s,cc,this.T3,T4)){
//                return true;
//    }   }}else{
...
//    i++;
//                   String OP4= token.get(i).cv;
//    String temp=T2;
//        if(T(s,cc,T2)){
//           this.T2= ST.Compatibility(OP4, temp, T2);
//           if(this.T2==null){
//            System.out.println("UncompatibleTYPE");
//            return false;
//        }
//            if(expdesh(s,cc,this.T2,T3)){
//                return true;
//    }   
//        }
//    }
...
//        i++;
//                       String OP5= token.get(i).cv;
//
//            String temp=T1;
//
//        if(F(s,cc,T1)){
//            
//                   this.T1= ST.Compatibility(OP5, temp, T1);
//    if(this.T1==null){
//            System.out.println("UncompatibleTYPE");
//            return false;
//        }
//            if(Tdesh(s,cc,this.T1,T2)){
//                return true;
//    }
//        }
//    }
...
//    }
//        return false;  }
//Boolean F(int CS,String cc,String T1){
//    
//String s=token.get(i).cp;
//    
// if(s.equals("ID")){
//    i++;
//         String N=token.get(i).cv;
//   // if(E8())
//  {
//      T1=ST.IDlookup(N, CS, cc);
//     if(T1==null){
...
//         System.out.println("UnDecleared ID");
//  }
//this.T1=ST.Compatibility("incdec", T1)
//if(this.T1==null){System.out.println("BAD OPERAND");}
//        return true;
//        }}}
...
//    i++;
//    if((F(s,cc,T1))){
//        this.T1=ST.Compatibility("!", this.T1);
//        if(this.T1==null){
//            System.out.println("BAD OPERAND");
//        }
//        return true;
//        }}
//else if(Const(s,cc,T1)){
//this.T1=T1;
//        return true;
//        }
...
//        return false;  } 
////////////////////////////////////////////////////////////////////////////////////////////////////////
//Boolean E1(int CS,String cc,String T1)
//{
//    if(token.get(i).cp.equals("->")){
//        i++;
//        if(token.get(i).cp.equals("ID")){
